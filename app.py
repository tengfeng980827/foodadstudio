...
<div class="container hero-wrap">
    <section class="hero">
        <div class="hero-card">
            <div class="hero-kicker">🔥 AI Food Creative Generator</div>
            <h1>
                专业外卖广告图，<br>
                <span class="gradient-text">一键生成。</span>
            </h1>
            <p>
                为餐饮品牌快速生成 GrabFood / Foodpanda 风格的头图、Banner 和产品视觉。
                支持 Logo、标题、价格、Badge、CTA，让广告图看起来更专业、更吸引点击。
            </p>

            <div class="hero-actions">
                <a class="btn btn-orange" href="/banner">开始做 Banner</a>
                <a class="btn btn-secondary" href="/poster">生成头图</a>
            </div>

            <div class="trust-row">
                <div class="pill">外卖广告图</div>
                <div class="pill">Logo 支持</div>
                <div class="pill">AI 智能场景</div>
                <div class="pill">高级排版</div>
            </div>
        </div>
        ...
        <div class="showcase">
            ...
            <div class="showcase-inner">
                <div class="showcase-badge">AI Generated</div>
                <div class="showcase-title">
                    <h2>Premium<br>Food Ads</h2>
                    <p>Clean layout · Logo ready · High conversion</p>
                </div>

                <div class="float-card">
                    <strong>+38%</strong>
                    <span>More attractive visuals</span>
                </div>
            </div>
        </div>
    </section>
...
<div class="container section">
    <div class="section-head">
        <div>
            <h2>选择你要生成的图片类型</h2>
            <p>不同用途对应不同版型，适合餐饮广告、外卖平台和菜单宣传。</p>
        </div>
    </div>

    <div class="feature-grid">
        <a class="feature-card" href="/poster">
            <div class="feature-icon">🍱</div>
            <h3>头图生成</h3>
            <p>适合外卖平台、菜单封面、单品宣传图和社媒广告图。</p>
        </a>

        <a class="feature-card" href="/banner">
            <div class="feature-icon">🖼️</div>
            <h3>Banner 生成</h3>
            <p>快速生成适合外卖平台使用的专业横幅广告图。</p>
        </a>

        <a class="feature-card" href="/product">
            <div class="feature-icon">✨</div>
            <h3>产品图</h3>
            <p>之后可扩展为白底图、场景图、电商产品图和菜单产品图。</p>
        </a>
    </div>
</div>
...
<div class="container section">
    <div class="section-head">
        <div>
            <h2>3 个步骤完成广告图</h2>
            <p>不需要设计经验，填写资料后让 AI 自动完成视觉设计。</p>
        </div>
    </div>
    ...
    <div class="steps">
        <div class="step">
            ...
            <h3>上传食物图</h3>
            <p>选择你要推广的主食物图片，也可以上传品牌 Logo。</p>
        </div>

        <div class="step">
            <div class="step-no">2</div>
            <h3>填写广告内容</h3>
            <p>输入标题、价格、促销 Badge 或 CTA，不需要的内容可以留空。</p>
        </div>

        <div class="step">
            <div class="step-no">3</div>
            <h3>下载成品</h3>
            <p>AI 会自动生成广告图，你可以直接下载 PNG 使用。</p>
        </div>
    </div>
</div>
